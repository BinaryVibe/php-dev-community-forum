        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-sm">
            <div class="container-fluid">
                ...
                <a href="index.php" class="navbar-brand">
                    ...
                    <span class="fw-bold text-primary">DevForum</span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="collapsible-bar">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active fw-bold" href="posts.php">Posts</a>
                        </li>
                ...
                <?php if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] == true): ?>
                    <div class='d-flex flex-nowrap column-gap-2'>
                        <a href='new_post.php' class='btn btn-primary d-flex align-items-center gap-2'>
                ...
                <?php while($post = $result->fetch_assoc()): ?>
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100 shadow-sm hover-card">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="show_post.php?id=<?php echo $post['post_id']; ?>" class="text-decoration-none text-dark stretched-link">
                            ...
                            <div class="card-footer bg-white border-top-0 d-flex justify-content-between text-muted small pb-3">
                                ...
                                <div>
                                    <span class="text-success me-2"><i class="bi bi-arrow-up"></i> <?php echo $post['upvotes']; ?></span>
                                    <span class="text-danger"><i class="bi bi-arrow-down"></i> <?php echo $post['downvotes']; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
